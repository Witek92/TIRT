...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.FilePlayer = QtGui.QPushButton(self.centralwidget)
        self.FilePlayer.setGeometry(QtCore.QRect(450, 50, 131, 31))
        self.FilePlayer.setObjectName(_fromUtf8("FilePlayer"))
        self.analyse = QtGui.QPushButton(self.centralwidget)
        self.analyse.setGeometry(QtCore.QRect(450, 90, 131, 31))
