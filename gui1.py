...
class Ui_Form(object):
    ...
    def retranslateUi(self, Form):
        ...
        self.IPsendTool.setText(_translate("Form", "Adres IP", None))
        self.IPrecTool.setText(_translate("Form", "Adres IP", None))
        self.PortsendTool.setText(_translate("Form", "Port", None))
        self.PortrecTool.setText(_translate("Form", "Port", None))
